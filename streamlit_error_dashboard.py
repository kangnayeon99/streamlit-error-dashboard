...
def load_data():
    ...
    df["발생_요일"] = df["event_time"].dt.dayofweek
...
# =========================
LOGIT_COEFS = {
    "W003": {"intercept": -18.7770, "실링온도": -0.8827, "쿠킹스팀압력": -11.3521,
             "요일_sin": -0.0444, "요일_cos": -0.1368, "월_sin": -0.0177, "월_cos": 0.1035, "순번": 0.1198},
    "W005": {"intercept": -9.8312, "실링온도": -0.6202, "쿠킹스팀압력": -6.3627,
             "요일_sin": 0.0540, "요일_cos": -0.1758, "월_sin": -0.0046, "월_cos": -0.1409, "순번": -0.0140},
    "W007": {"intercept": -12.2807, "실링온도": -0.3179, "쿠킹스팀압력": -7.4421,
             "요일_sin": -0.1107, "요일_cos": -0.0362, "월_sin": -0.0022, "월_cos": 0.0012, "순번": -0.0350},
    "W002": {"intercept": -6.9799, "실링온도": 0, "쿠킹스팀압력": -4.2259,
             "요일_sin": -0.1545, "요일_cos": 1.2826, "월_sin": -0.1790, "월_cos": 0.3335, "순번": -0.3237},
}
...
# 이후: 메뉴별 페이지 구현
# =========================
# 👉 여기서부터는 제가 이미 올려주신 월별 분석, 공정 모니터링, 실시간 감지 그대로 붙여 넣으면 됩니다.
# (위 load_data 블럭만 올바르게 교체하면 SyntaxError, IndentationError 안 납니다.)
